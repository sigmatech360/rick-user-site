...
const Profile = () => {
    const { ApiData: ApiData, loading: loading, error: error, get: getdata } = useGet('/edit-account')
    const { ApiData: ApiDataPost, loading: Postloading, post: Posterror, post: post } = usePost('/update-account')
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="row g-3">
                                    ...
                                    <div className="col-md-12">
                                        <Form.Group className="mt-3" controlId="weekDays">
                                            ...
                                            <div className="dropdown-input  d-flex align-items-center border rounded gap-2 p-2" onClick={toggleDropdownslots}>
                                                ...
                                                <span>
                                                    {Array.isArray(selectedItemsslots) && selectedItemsslots.length > 0
                                    ...
                                    <div className="col-12">
                                        <button type="submit" className="btn btn-primary w-100 profile-update">
                                            Update
                                        </button>
                                    </div>
                                </div>
